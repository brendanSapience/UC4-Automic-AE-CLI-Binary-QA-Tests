...
$FolderName = "API.TESTS.TARGET"
 ...
 AddToATestCaseSuiteFullWithKeywordChecks $JavaBin "-commit -fr_name '*' -fr_type 'JOBS' -fr_rangestarttime `"['20170101-0000','20180101-0000']`" -fr_rangeendtime `"['20170101-0000','20180101-0000']`"" 0 "" ""
